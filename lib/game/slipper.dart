...
enum Stat {
  ...
  health('Здоровье', 'Зд', 'Запас здоровья и размер тапка'),
...
class Slipper {
  ...
  /// Размер тапка на экране: 50% на старте, +1% за уровень Здоровья,
  /// потолок 100% (достигается на 51-м уровне).
  double get sizeFactor => min(1.0, 0.5 + (level(Stat.health) - 1) * 0.01);
